...
Before any mode-specific work, read [MEMORY.md](MEMORY.md).

- Treat it as a versioned list of verified lessons from previous `frontend-slides` runs.
- Use it to avoid repeated failures in generation, modification, and verification.
- If the current task reveals a reusable lesson, update `MEMORY.md` before delivery.
...
- [MEMORY.md](MEMORY.md) — Verified lessons, failure patterns, and verification checks from previous runs
...
4. **Update memory when warranted** — If the task produced a reusable lesson or revealed a new failure pattern, update `MEMORY.md`
...
|------|---------|-------------|
| [MEMORY.md](MEMORY.md) | Verified lessons learned, failure patterns, and delivery checks from previous runs | Before any mode-specific work; always again before Phase 3 generation |
